				...
				<div class="block-panel">
					...
					<div class="block-body">
						<div class="row">
							...
							<!-- Ma khuyen mai -->
							<div class="col-lg-2 col-md-4 col-sm-12">Mã khuyến mãi:</div>
							<div class="col-lg-2 col-md-2 col-sm-4 col-xs-4">
								<input name="txt_coupon" class="form-control" value="<?=(isset($txt_coupon) ? $txt_coupon : '')?>"/>
								<span class="text-danger"><?php echo form_error('$txt_coupon'); ?></span>
							</div>
