...
<head>
	...
	<meta name="description" content="Bất động sản nhà đất dưới một tỷ, nhà đất rẻ">
	<meta name="keywords" content="dưới, một, tỷ, nhà, rẻ,trung, cấp">
	<meta name="revisit-after" content="1 days" />
	<meta name="robots" content="follow" />
	<title>Bất động sản dưới một tỷ</title>
...
<ul itemscope itemtype="http://schema.org/BreadcrumbList" class="breadcrumb">
	<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a href="<?=base_url()?>" itemprop="item"><span itemprop="name">Trang chủ</span></a><meta itemprop="position" content="1" /></li>
	<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem" class="active"><span itemprop="item"><span itemprop="name">Bất động sản dưới một tỷ</span></span><meta itemprop="position" content="2" /></li>
	<?php $this->load->view('/common/quick-search')?>
</ul>
<div class="row no-margin">
	<div class="col-md-9  no-margin no-padding">
		<div class="product-title"><h1 class="h1Class" itemprop="name">BẤT ĐỘNG SẢN DƯỚI 1 TỶ</h1></div>
