...
$route['bao-gia/(:any)/xem-chi-tiet'] = "Quotation_controller/view/$1";
...
$route['admin/report/load'] = "admin/Report_controller/load";
...
$route['admin/promotion/list'] = "admin/Promotion_controller";
$route['admin/promotion/edit'] = "admin/Promotion_controller/edit";
$route['admin/promotion/edit-(:num)'] = "admin/Promotion_controller/edit/$1";
